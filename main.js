...
const renderPets = (arr) => {
  ...
  for (const pet of arr) {
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item">Special Skill: ${pet.specialSkill}</li>
      <li class="list-group-item">Type: ${pet.type}</li>
      <li class="list-group-item"><button id="${pet.name}-${pet.id}">Delete</button></li>
    </ul>
  </div>`;
  }

  petContainer.innerHTML = domString;

  pets.forEach(pet => {
    document.getElementById(`${pet.name}-${pet.id}`).addEventListener("click", () => deletePet(pet.id))
  })
...
document
  ...
  document
  .getElementById("catBtn")
  .addEventListener("click", () => renderFilterdPets("cat"));

  document
  .getElementById("dinoBtn")
  .addEventListener("click", () => renderFilterdPets("dino"));

  document
  .getElementById("clearBtn")
  .addEventListener("click", () => renderPets(pets));
